!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="",__webpack_require__(0)}([function(module,exports,__webpack_require__){"use strict";__webpack_require__(1)},function(module,exports,__webpack_require__){"use strict";var $=__webpack_require__(2);$(function(){$("#qu").on("focus",function(){if($(this).val().length>0){$(this).val("");var i=100,stop=1,pxls=1.3,interval=setInterval(function(){var $span=$("#result").find("span");return pxls+=1.3,$span.next().css("bottom","-"+pxls+"px"),$span.text(i-stop+"%"),stop++,i==stop-1?($span.next().css("background","rgba(221, 0, 0, 0.82)"),void clearInterval(interval)):void 0},5)}}),$("#f").on("submit",function(e){e.preventDefault(),$("#btn").prop("disabled",!0),$("#result").fadeIn(150);var i=1,stop=100,pxls=131,interval=setInterval(function(){var $span=$("#result").find("span");return pxls-=1.3,$span.next().css("bottom","-"+pxls+"px"),$span.text(i+"%"),i++,110>pxls&&pxls>=60?$span.next().css("background","rgba(255, 214, 0, 0.77)"):95>pxls&&$span.next().css("background","rgba(100, 221, 23, 0.65)"),i==stop+1?($("#btn").prop("disabled",!1),void clearInterval(interval)):void 0},50*i)}),$(".switch.back").on("click",function(e){e.preventDefault();var item=parseInt($(this).data("item"))-1;$(this).data("item",item),$(".switch.forward").data("item",item),$("body").css({"background-image":"url(http://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-"+item+".jpg)","background-size":"cover"})}),$(".switch.forward").on("click",function(e){e.preventDefault();var item=parseInt($(this).data("item"))+1;$(this).data("item",item),$(".switch.back").data("item",item),$("body").css({"background-image":"url(http://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-"+item+".jpg)","background-size":"cover"})})})},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
